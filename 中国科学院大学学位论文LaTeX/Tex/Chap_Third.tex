...
\begin{figure}[htbp]
  \centering
    ...
    \includegraphics[width=0.4\linewidth]{毕设/毕业论文/附件4 中国科学院大学学位论文LaTeX模板/Img/对称棘轮.png} 
    \caption{对称棘轮示例}
...
\begin{figure}[htbp]
  \centering
    ...
    \includegraphics[width=0.3\linewidth]{毕设/毕业论文/附件4 中国科学院大学学位论文LaTeX模板/Img/非对称.png} 
    \caption{非对称棘轮示例}
    \label{fig:perf-comparison}
