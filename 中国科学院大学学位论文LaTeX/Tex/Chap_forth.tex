...
\begin{figure}[htbp]
  \centering
    ...
    \includegraphics[width=0.9\linewidth]{毕设/毕业论文/附件4 中国科学院大学学位论文LaTeX模板/Img/架构模型.png} 
    \caption{协议整体架构}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{毕设/毕业论文/附件4 中国科学院大学学位论文LaTeX模板/Img/基于Intel SGX的Tag-KEM安全实现架构.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{毕设/毕业论文/附件4 中国科学院大学学位论文LaTeX模板/Img/Enclave内安全的Tag-KEM解封装流程.png}
